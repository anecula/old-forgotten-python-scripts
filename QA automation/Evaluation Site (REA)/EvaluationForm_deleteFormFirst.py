...
class EvaluationPeriods_deleteFormFirst (loginclassUsers.Auto):
    def test_sort(self):
        ...
        ActionChains(driver).key_down(Keys.SHIFT)
        time.sleep(3)
        driver.find_element_by_xpath("/html/body/div/form/div[3]/div[4]/div/select/optgroup[2]/option[11]").click()
        ActionChains(driver).key_down(Keys.SHIFT)
        ...
        driver.find_element_by_xpath("/html/body/div/form/div[3]/div[3]/div/select/optgroup[2]/option[3]").click()
        time.sleep(3)
        driver.find_element_by_xpath("/html/body/div[1]/form/input").click()
        time.sleep(3)
        ...
        try:
            ...
            print("You can not delet a Form used in an Evaluation Period")
